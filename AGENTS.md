...
src/
  ...
  tools/                ← one folder per API tag, one file per endpoint
    authoring/          ← conventions.ts (v2.1.0) — the first tool over the new
                          ...
                          for a human (D42)
                          add-draft-attachment.ts, update-draft-attachment.ts,
...
- [docs/sprints/sprint-2026-W35.md](docs/sprints/sprint-2026-W35.md) — `closed`
  2026-09-07 (2026-08-24 → 2026-08-30): 1 story / 2 points, US-2.14 shipped `2.8.1`
...
- [docs/superpowers/plans/2026-09-11-pr-ci-gate-w37.md](docs/superpowers/plans/2026-09-11-pr-ci-gate-w37.md) — its plan, task by task (filed as EPIC-10 / US-10.1)
