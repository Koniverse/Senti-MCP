...
**Contents**: [0. Pick a pattern — inline vs. file-extracted](#0-pick-a-pattern--inline-vs-file-extracted) · [1. Pattern A — Inline CLAUDE.md Integration Block](#1-pattern-a--inline-claudemd-integration-block) · [2. Pattern B — File-extracted active-context (recommended for teams)](#2-pattern-b--file-extracted-active-context-recommended-for-teams) · [3. AGENTS.md ⇄ CLAUDE.md — project file architecture](#3-agentsmd--claudemd--project-file-architecture) · [4. Trigger points (when to update Active Context)](#4-trigger-points-when-to-update-active-context) · [5. Filled example — `.active-context.md` (Pattern B, recommended)](#5-filled-example--active-contextmd-pattern-b-recommended) · [6. Filled example — `CLAUDE.md` Active Context (Pattern A, legacy)](#6-filled-example--claudemd-active-context-pattern-a-legacy)
