...
In `sprint-2026-W33.md`, mark US-2.4 done in the scope table. `npm run agile:status` in Step 6 regenerates `STATUS.md` from that. No Active Context block is written (Global Constraints, [CONTEXT D10](../../CONTEXT.md)).
...
- `docs/sprints/STATUS.md` → regenerated by `agile:status`; it is the only in-flight snapshot ([CONTEXT D10](../../CONTEXT.md))
