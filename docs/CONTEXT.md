...
## Phase 3 — Doc hygiene (2026-08-07)

### D10. No Active Context block in this repo (revision of D4)
...
`docs/README.md` drops the checklist item and records the absence. The W33 plan is
amended so its per-story close steps no longer recreate the block; closed stories and
the CHANGELOG keep their references, because they record what did happen.
